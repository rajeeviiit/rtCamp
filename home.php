    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <img src="<?php echo 'https://graph.facebook.com/' . $user->getProperty('id') . '/picture?type=normal' ?>"
                 style="float:left;background-color: white; padding: 2px; border: 1px solid #dddddd;"/>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-7 text-center">
            <div id="top_buttons">
                ...
                <button class="btn btn-success" id="move_all">Move All</button>
                <button class="btn btn-success" id="move_selected">Move Selected</button>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="album">
                ...
                <div class="content">
                    ...
                    <button class="btn btn-success move_album" data-id="<?php echo $album['id']; ?>">Move to Drive</button>
                </div>
